--this is literally just the minetest game doors mod slightly tweaked
...
minetest.register_craft({
	...
	recipe = {
		...
		{"nodes:wood", 'group:wood', "nodes:wood"},
	}
})
