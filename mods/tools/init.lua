...
local tool_break = function(itemstack, user, node, digparams)
...
minetest.register_tool("tools:wood_axe",
    {
        ...
        on_use = function(itemstack, user, pointed_thing)
          ...
          minetest.add_particle({
            pos = pos1,
            velocity = {x=math.random(-5,5)+(math.random()*math.random(-1,1)), y=math.random(4,7)+(math.random()*math.random(-1,1)), z=math.random(-5,5)+(math.random()*math.random(-1,1))},
